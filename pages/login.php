    ...
    <body class="flex justify-center items-center h-screen w-screen">
        ...
        <div action="" method="post" class="bg-[rgb(30,30,30)] rounded-lg shadow-lg shadow-gray-950 w-[500px] h-[600px] px-7 py-12 flex flex-col">
            ...
            <form action="" method="post" class="formField w-full h-full flex flex-col justify-start items-center">
                ...
                <input type="email" name="email" id="email" class="px-4 py-3 w-full text-black outline-none rounded-xl mb-7 cursor-text focus:bg-[rgb(229,240,255)] duration-[0.4s] transition-all">
                <label for="password" class="w-full text-start mb-4">Password:</label>
                <div class="password w-full flex  mb-7">
                    <input type="password" name="password" id="password" class="px-4 py-3 w-full text-black outline-none rounded-xl rounded-tr-none rounded-br-none cursor-text focus:bg-[rgb(229,240,255)] duration-[0.4s] transition-all">
                    <button class="h-full w-[10%] bg-white rounded-tr-xl rounded-br-xl flex justify-center items-center border-l border-[rgba(191,191,191,0.74)] border-solid cursor-pointer hover:bg-[rgb(229,240,255)] duration-[0.4s] transition-all">
                ...
                <div class="check w-full flex justify-start items-center mb-7 pl-4">
                    <input type="checkbox" name="remember" id="remember">
                    <label for="remember" class="ml-5">Remember me</label>
                </div>
                <input type="submit" value="Login" class="px-4 py-3 w-1/2 text-white rounded-full cursor-pointer bg-[rgb(51,51,51)]">
